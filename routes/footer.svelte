<footer class="flex flex-col items-center text-center prose dark:prose-invert">
	...
	<div class="w-full p-4 text-center bg-gray-300 dark:bg-gray-800">© 2023 Copyright: News Corp</div>
</footer>
